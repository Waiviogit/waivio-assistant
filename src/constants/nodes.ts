...
export const AGENTS_DESCRIPTION = {
    ...
    SitesManagement: 'questions related to how create site on waivio platform and manage it',
    WaivioObjects: 'questions related to how objects works, how create objects, how to fill objects with info',
    WaivioGeneral: 'general questions related to waivio how it works, what it is, about posts, news feeds, shops, hive account',
};
