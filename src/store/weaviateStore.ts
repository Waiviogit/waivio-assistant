...
export const getWeaviateStore = async (indexName: string): Promise<WeaviateStore> => {
...
export const createWeaviateIndex = async ({text, indexName}: createWeaviateIndexInterface): Promise<void> => {
